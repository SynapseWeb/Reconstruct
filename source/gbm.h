/* modified by JCF 11/26/02 for Borland C++ 5.5 Command Line Tools
  NOTE MODIFICATIONS BELOW THAT MUST BE INSERTED PRIOR TO USE WITH OTHER CODE,
  THESE ARE DIFFERENT FROM THE SETTINGS WHEN COMPILING THE LIBRARY ITSELF!
...
#define BOOLEAN_DEFINED						// JCF 11/26/02: uncoment to link with Borland's wtypes.h

#ifndef IJG
#define IJG									// JCF 11/26/02: uncomment to include JPEG library (also edit makefile)
#endif
...
#else
*/
										// JCF 11/26/02: switch to extern "C" when compile application
#define	GBMEXPORT extern "C"
//#define	GBMEXPORT
#define	GBMENTRY 
//#endif
